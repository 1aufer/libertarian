...
export default function Sobre() {
  return (
    <div className="container">
      ...
      <h2 className="subtitulo">Livros para um libertário iniciante</h2>
      <ol>
        <li> A Lei – Frederick Bastiat </li>
        <li> Anatomia do Estado – Murray N. Rothbard </li>
        <li >A Ética da Liberdade – Murray N. Rothbard </li>
        <li> Uma breve história do homem: Progresso e declínio – Hans-Hermann Hoppe </li>
      </ol>
      ...
      <p className='texto'>Para saber mais sobre libertarianismo, confira os seguintes links:</p>
      <ul>
